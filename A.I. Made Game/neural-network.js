...
class neuralNetwork {
  constructor(numInputs, numHidden, numOutputs) {
    ...
    train(inputArray, targetArray){
      ...
      //calculate the output errors (target - actual)
      ...
      //calculate the hidden layer errors (deltas 'dot' product with transpose of weights1)
      let weights1T = Matrix.transpose(this.weights1);
      let hiddenErrors = Matrix.dot(outputDeltas, weights1T);
     

      //calculate the hidden deltas (errors * derivative of the hidden)
